...
export default function AppWebsiteVisits() {
  ...
  useEffect(() => {
    async function getData() {
      ...
      setLabels(res.data[0].Resultados);
      setLabels2(res2.data[0].Resultados);
      setLabels3(res3.data[0].Resultados);

      setTitle(res.data[0].Indicador);
      setPercents(res.data[0].Porcentagens);
      setPercents2(res2.data[0].Porcentagens);
      setPercents3(res3.data[0].Porcentagens);
    }
    getData();
  }, []);
